...
export default function CTA({ data }: CTAProps) {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20 text-center bg-gradient-to-br from-green-600 via-green-700 to-green-800 text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <a
          href={buttonUrl}
          className="inline-block px-8 sm:px-10 py-3 sm:py-4 rounded-xl bg-white text-green-700 font-bold text-base sm:text-lg hover:bg-green-50 transition-all duration-300 shadow-2xl hover:shadow-xl hover:scale-102"
        >
          {buttonLabel}
        </a>
      </div>
